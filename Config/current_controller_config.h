...
// Current controller///
// Reverted to original defaults for more conservative gains.
// Original comment for K_SCALE: K_loop/Loop BW (Hz) 0.0042
#define K_SCALE         0.0001f     // K_loop/Loop BW (Hz) 0.0042
// Original comment for KI_D/KI_Q: PI zero, in radians per sample
